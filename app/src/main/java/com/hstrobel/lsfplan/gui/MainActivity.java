...
public class MainActivity extends AppCompatActivity {
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (id == R.id.action_settings) {
      ...
      Snackbar.make(findViewById(android.R.id.content), R.string.main_calendar_updating,
  ...
  protected void onResume() {
    ...
    try {
      ...
      if (state.myCal == null) {
        //show intro
        getFragmentManager().beginTransaction().replace(R.id.mainFragmentContainer, defaultFragment)
            .commit();
      } else {
        getFragmentManager().beginTransaction().replace(R.id.mainFragmentContainer, listFragment)
            .commit();
      }
